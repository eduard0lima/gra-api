...
class PremiacaoIntegrationTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    void deveRetornarIntervalosDePremiacaoDosProdutores() throws Exception {
        mockMvc.perform(get("/api/v1/producers/award-intervals"))
